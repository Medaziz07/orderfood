...
import com.android.OrderFood.adapters.PlaceYourOrderAdapter;
...
//appel au nom et adress du resto
...
//
        ...
        switchDelivery.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            //la methode ou on clique sur le radiobox change de formulaire(disponibilité de nom,adress,city,zip...)
            @Override
...
//fonction pour calculer la somme de l'ordre reservé
    private void calculateTotalAmount(RestaurantModel restaurantModel) {
        //declaration du montant initile a 0
        float subTotalAmount = 0f;
//calcul du montant(appel au montant dans la liste des restos*le nombre d'article reservé)
